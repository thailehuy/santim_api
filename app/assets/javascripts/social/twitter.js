with (scope('Twitter','App')) {
  ...
  *   default text  - @ST | The funding platform for open source software
  ...
  * */
  define('create_share_button', function() {
    ...
    e.addEventListener('click', function(e) {
      ...
      options['text']     = encode_html(options['text'] || '@ST | The funding platform for open source software');
  ...
  /*
   * Link Twitter to ST account via oauth redirect.
   * */
  define('auth_url', function(options) {
    options = options || {};
    return ST.api_host+'auth/twitter?scope='+(options.scope||'') +
